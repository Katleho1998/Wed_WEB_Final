  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 flex flex-col items-center justify-center w-full h-full px-2 sm:px-4 max-w-2xl mx-auto py-8 sm:py-12 text-center">
        ...
        <span className="block mb-2 text-[8px] sm:text-sm md:text-base lg:text-lg font-semibold text-mocha-500 tracking-wide text-center uppercase">
        ...
        <SplitText
          text="Thabi & Trevor"
          className="font-serif text-bold text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-dusty-800 mb-2 animate-fadeIn leading-tight flex items-center justify-center gap-2 sm:gap-4 text-center"
          delay={100}
          duration={0.6}
          ease="power3.out"
          splitType="chars"
